...
I<Note that these sent files, which are zero byte files, will accumulate in the queued directory and will persist in logged messages when verbose is enabled. This may get annoying and I take no responsibility for annoying you.>
